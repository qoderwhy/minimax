...
### 错误码
- `200` 成功；`400/401/403/404/405/422/429/500` 为 HTTP 语义通用码（含 `TIME_FORMAT_INVALID`=400、`REPEAT_SUBMIT`=429）
- `10001-10009` 用户相关（10001 用户不存在、10002 密码错误、10003 用户被禁用、10004 账号锁定、10005 用户名已存在、10007-10009 自我保护）
- `10101-10102` 验证码
- `11001-11004` 角色相关
- `12001-12002` 菜单相关
- `13001-13003` 部门相关
